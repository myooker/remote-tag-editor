...
crow::response oggVorbisTagHandler::removeMusicTag(const std::string &filePath, const std::string &fieldType, const std::string &value) {
...
crow::response oggVorbisTagHandler::addMusicTag(const std::string &filePath, const std::string &fieldType, const std::string &value) {
   TagLib::Ogg::Vorbis::File file { filePath.c_str() };
...
crow::response oggVorbisTagHandler::editMusicTags(const std::string &filePath, const std::string &fieldType, const std::string &replaceWith) {
   TagLib::Ogg::Vorbis::File file { filePath.c_str() };
...
crow::response oggVorbisTagHandler::editMusicTags(const std::string &filePath, const std::string &fieldType, const std::string &replaceWhat, const std::string &replaceWith) {
   TagLib::Ogg::Vorbis::File file { filePath.c_str() };
