...
crow::response oggFlacTagHandler::removeMusicTag(const std::string &filePath, const std::string &fieldType, const std::string &value) {
   TagLib::Ogg::FLAC::File file { filePath.c_str() };
...
crow::response oggFlacTagHandler::addMusicTag(const std::string &filePath, const std::string &fieldType, const std::string &value) {
   TagLib::Ogg::FLAC::File file { filePath.c_str() };
...
crow::response oggFlacTagHandler::editMusicTags(const std::string &filePath, const std::string &fieldType, const std::string &replaceWith) {
   TagLib::Ogg::FLAC::File file { filePath.c_str() };
...
crow::response oggFlacTagHandler::editMusicTags(const std::string &filePath, const std::string &fieldType, const std::string &replaceWhat, const std::string &replaceWith) {
   TagLib::Ogg::FLAC::File file { filePath.c_str() };
