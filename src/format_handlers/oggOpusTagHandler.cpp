...
crow::response oggOpusTagHandler::removeMusicTag(const std::string &filePath, const std::string &fieldType, const std::string &value) {
   TagLib::Ogg::Opus::File file { filePath.c_str() };
...
crow::response oggOpusTagHandler::addMusicTag(const std::string &filePath, const std::string &fieldType, const std::string &value) {
   TagLib::Ogg::Opus::File file { filePath.c_str() };
...
crow::response oggOpusTagHandler::editMusicTags(const std::string &filePath, const std::string &fieldType, const std::string &replaceWith) {
   TagLib::Ogg::Opus::File file { filePath.c_str() };
...
crow::response oggOpusTagHandler::editMusicTags(const std::string &filePath, const std::string &fieldType, const std::string &replaceWhat, const std::string &replaceWith) {
   TagLib::Ogg::Opus::File file { filePath.c_str() };
